...
public class CurrentPlayerInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GamePlayer activePlayer = gameManager.getPlayerByGame(game, userManager.getUser(userName));
            String json = gson.toJson(activePlayer);
            out.println(json);
            out.flush();
        }
    }
